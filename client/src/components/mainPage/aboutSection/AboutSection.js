	...
	return (
        ...
        services for customers across the city of Coventry.
			...
			<ul className={classes.about__list}>
				<li className={classes.about__list__element}><a href="https://www.covrefugee.org/" target="_blank" rel="noreferrer" ><img src={coventryRefLogo} /></a></li>
				<li className={classes.about__list__element}><a href="https://codeyourfuture.io/" target="_blank" rel="noreferrer"><img src={cyfLogo} /></a></li>
			</ul>
		</div>
	);
};
